...
public class RenderBatch {
    ...
    public void addSprite(SpriteRenderer sprite) {
        ...
        // Add properties to local verticies arrary //
    ...
    public void render() {
        // (For now) All data will be rebuffered in every frame //
        glBindBuffer(GL_ARRAY_BUFFER, vboID);
    ...
    private void loadVertexProperties(int index) {
        ...
        // Find the offset within array (4 verticies per sprite) //
        int offset = index * 4 * VERTEX_SIZE;
        
        Vector4f colour = sprite.getColor();

        // Add vertices woth the needed propertise //
        float xAdd = 1f;
        float yAdd = 1f;
        for (int i = 0; i < 4; i++) {
            if (i == 1) {
